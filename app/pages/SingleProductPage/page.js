    ...
    <>
      ...
      <div className={styles.parent}>
        ...
        <div className={styles.description}>
          ...
          high power devices or appliances using arduino or microcontrollers,
          the relay is rated for 230V 10Amps. The Module has 5 LED’s, one for
          power and 4 for indicating relay signals.
        </div>
        <div
          style={{
            width: "77%",
        ...
        >
          ...
          <li>
            IN1 – set to HIGH to set the relay to its “default” state, set to
            LOW to switch the relay to its alternate state
          </li>
